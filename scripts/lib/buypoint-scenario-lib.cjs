...
function resolveOddsTier(score) {
...
function getLatestSignalOdds(classified) {
  ...
  if (limitUpCount5 >= 1 && dayReturn != null && dayReturn >= 3 && (upperShadowRatio == null || upperShadowRatio <= 0.2)) {
    score += 8;
  ...
  if (dayReturn != null && dayReturn < 0 && limitUpCount5 === 0) {
    if (score >= 58) {
      score = 57;
